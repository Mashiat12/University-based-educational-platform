        ...
        <div class="dash-content">
            ...
            <div class="activity-data">
                <?php foreach ($data as $row): ?>
                    <div class="data">
                        <p><span class="data-title">Name:</span> <?php echo $row['Full Name']; ?></p>

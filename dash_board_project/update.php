...
<body>
   ...
   <section class="space">
      ...
      <div class="container">
         ...
         <div class="profile">
            <?php
            $select = mysqli_query($conn, "SELECT * FROM `teacher` WHERE user_id = '$user_id'") or die('query failed');
         ...
         <div class="details">
            <p class="row"><span class="attr">User Name: </span><?php echo $fetch['Full Name']; ?></p>
            <p class="row"><span class="attr">Email: </span><?php echo $fetch['Email']; ?></p>
            <p class="row"><span class="attr">Mobile No: </span><?php echo $fetch['Subject']; ?></p>
            <p class="row"><span class="attr">Address: </span><?php echo $fetch['Salary']; ?></p>
         </div>
         <div class="change">
